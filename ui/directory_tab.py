...
def build_directory_tab(self):
    ...
    load_btn = ctk.CTkButton(self.directory_tab, text="加载 Novel_directory.txt", command=lambda: self.load_chapter_blueprint(self), font=("Microsoft YaHei", 12))
    ...
    save_btn = ctk.CTkButton(self.directory_tab, text="保存修改", command=lambda: self.save_chapter_blueprint(self), font=("Microsoft YaHei", 12))
